<div class="w-full max-w-xs flex flex-col gap-4">
    <div class="flex flex-col w-full max-w-xs">
        <x-ui.collapse.trigger target="demo-collapse" class="gap-2 text-sm text-foreground py-1 w-full justify-between">
    ...
    <div class="flex flex-col w-full max-w-xs">
        <x-ui.collapse.trigger indicatorType="plus-sign" target="demo-collapse-2"
            class="gap-2 text-sm text-foreground py-1 w-full justify-between">
