        ...
        <div class="grid sm:grid-cols-2 divide-border-strong/70 divide-dashed">
            <div class="border-b sm:border-r p-3.5 sm:p-5 lg:p-6.5">
                <span class="flex items-center text-sm text-muted-foreground">
                    <x-ui.icon name="ph--cube" class="mr-2" />
                    Ready Primitives
                </span>
                ...
                <div class="mt-5 aspect-video bg-card rounded-ui pointer-events-none">
            ...
            <div class="border-b p-3.5 sm:p-5 lg:p-6.5">
                <span class="flex items-center text-sm text-muted-foreground">
                    <x-ui.icon name="ph--wall" class="mr-2" />
                    Smart Blocks
                </span>
                <h2 class="font-semibold text-foreground text-xl md:text-2xl mt-4">
            ...
            <div class="sm:col-span-full grid sm:grid-cols-2 md:grid-cols-3 divide-border-strong/70 divide-dashed">
                @foreach ($bottomFeatures as $feature)
                    <div
                        ...
                        <span class="flex items-center text-sm text-muted-foreground">
                            <x-ui.icon name="{{ $feature['icon'] }}" class="mr-2" />
                            {{ $feature['subtitle'] }}
                        </span>
                        <h2 class="font-semibold text-xl text-foreground mt-4 mb-5">
                            {{ $feature['title'] }}
                        </h2>
                        @if ($feature['name'] == 'code-own')
                            <div class="rounded-ui bg-card mt-auto h-52 relative">
                        ...
                        @elseif ($feature['name'] == 'blade-livewire')
                            <div aria-hidden="true"
                                class="rounded-ui bg-card mt-auto h-52 px-10 py-10 flex items-center justify-center relative">
                                ...
                                <span class="absolute top-1/2 left-1/2 -translate-1/2 w-7 h-15 bg-linear-to-t from-muted-foreground via-foreground to-foreground rounded-full blur-lg dark:blur-2xl not-dark:opacity-35"></span>
                                <div class="grid grid-cols-3 w-full relative">
                                    <div class="flex items-center gap-0.5">
                                        <span class="size-10 rounded-ui bg-background  border border-border d-flex-place-center">
                                            <x-ui.icon name="simple-icons--tailwindcss" class="flex text-primary" />
                                        </span>
                                        <span
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="size-10 rounded-ui bg-background  border border-border d-flex-place-center">
                                            <x-ui.icon name="simple-icons--laravel" class="flex text-red-600 dark:text-red-500" />
                                        </span>
                                        <span
                                    ...
                                    <div class="flex items-center gap-0.5">
                                        ...
                                        <span class="size-10 rounded-ui bg-background  border border-border d-flex-place-center">
                                            <x-ui.icon name="simple-icons--livewire" class="flex text-pink-600 dark:text-pink-500" />
                                        </span>
                                    </div>
                                </div>
                            </div>
                        @else
                            <div
                                class="rounded-ui bg-card mt-auto h-52 flex d-flex-place-center relative">
                                <span aria-hidden="true"
                                    class="absolute inset-x-3 md:inset-x-6 h-px bg-linear-to-r from-border-strong/40 via-border-strong/60 to-border top-5"></span>
                                <span aria-hidden="true"
                                    class="absolute inset-x-3 md:inset-x-6 h-px bg-linear-to-r from-border-strong/40 via-border-strong/60 to-border bottom-5"></span>
