...
<div class="w-full max-w-7xl px-1 sm:px-4 mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-muted-foreground mt-0.5">Manage your team members and their permissions.</p>
        </div>
        <x-ui.modal.trigger modal-id="create-user" variant="solid" intent="primary" size="sm">
    ...
    <x-ui.card size="custom" class="[--card-padding:0px]">
        <div class="p-4 flex items-center justify-between gap-4 border-b border-border">
            ...
            <div class="flex items-center gap-2">
                <x-ui.button size="none" variant="outline" class="gap-1 sm:btn-sm max-sm:btn-icon-sm">
    ...
    <x-ui.modal id="create-user">
        <x-ui.modal.content size="lg">
            <x-ui.modal.header title="Add User" description="Fill in the details to invite a new team member." />
            <x-ui.modal.body class="space-y-4">
                ...
                <x-ui.input type="email" label="Email" placeholder="john@company.com" />
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
