<x-ui.card size="none" class="rounded-ui">
    ...
    <div class="px-6 pb-6 space-y-4">
        <div class="flex items-start space-x-3 p-3 rounded-lg hover:bg-muted/50 transition-colors">
            ...
            <div class="flex-1 space-y-1">
                <div class="flex items-center space-x-2">
                    <x-ui.icon name="ph--chat-dots" class="text-sm text-primary" />
                    <p class="text-sm">
                        <span class="font-medium text-foreground">Sarah Chen</span>
                        <span class="text-muted-foreground ml-1">commented on your post</span>
                    </p>
                </div>
                <p class="text-sm text-muted-foreground bg-muted p-2 rounded border-l-2 border-primary">
        ...
        <div class="flex items-start space-x-3 p-3 rounded-lg hover:bg-muted/50 transition-colors">
            ...
            <div class="flex-1 space-y-1">
                <div class="flex items-center space-x-2">
                    <x-ui.icon name="ph--user" class="text-sm text-primary" />
                    <p class="text-sm">
        ...
        <div class="flex items-start space-x-3 p-3 rounded-lg hover:bg-muted/50 transition-colors">
            ...
            <div class="flex-1 space-y-1">
                <div class="flex items-center space-x-2">
                    <x-ui.icon name="ph--share" class="text-sm text-primary" />
                    <p class="text-sm">
