...
<div x-data x-offcanvas data-slideover data-offcanvas-backdrop="fixed inset-0 bg-background /50 z-60 {{ $backdrop_blur }}"
    ...
    {{ $attributes->class([
        ...
        'transition-[transform_opacity] duration-300 ease-linear group',
        $size_class,
        $u_position,
