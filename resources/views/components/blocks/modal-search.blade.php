    ...
    <x-ui.modal.content x-data="searchDocs" :closable="false" no-gutter size="md"
        ...
        <x-ui.modal.header padding-none class="relative w-full">
            <x-ui.input @input="search" data-input-search variant="unstyled"
                ...
                x-model="query" />
            <x-ui.icon name="ph--magnifying-glass" class="absolute left-3.5 top-3 text-muted-foreground text-sm" />
        </x-ui.modal.header>
        <x-ui.modal.body data-search-results
            class="[--gutter:--spacing(0)] overflow-y-auto bg-card border border-border ui-card [--card-radius:var(--radius-ui)] [--card-padding:--spacing(0.5)] shadow-sm">
                    ...
                    <a :href="item.slug"
                        ...
                        <div class="flex min-w-max text-muted-foreground">
                            <template x-if="item.isComponent && !item.isTheming">
                                <x-ui.icon name="ph--cube" class="size-5" />
                            </template>
                            <template x-if="item.isTheming">
                                <x-ui.icon name="ph--palette" class="size-5" />
                            </template>
                            <template x-if="item.isDocumentation && !item.isTheming">
                                <x-ui.icon name="ph--file-text" class="size-5" />
                            </template>
                        </div>
                        <div class="flex-1 overflow-hidden flex flex-col">
                            <div class="text-sm font-medium text-foreground line-clamp-1" x-text="item.title"></div>
                ...
                <div class="size-full d-flex-place-center flex-col text-center py-4">
                    <svg width="128" height="128" viewBox="0 0 128 128" fill="none"
                        ...
                        <g clip-path="url(#clip0_33_172)">
                            <circle cx="60.7768" cy="62.7768" r="60.7768" fill="currentColor" class="text-background-muted/50 dark:text-border" />
                            ...
                            <path
                                ...
                                class="text-background-muted/70 dark:text-border stroke-primary-400 dark:stroke-primary-900" stroke-width="2" />
                            ...
                            <path
                                ...
                                fill="white" class="fill-background" />
                            <path
                        ...
                        <defs>
                            <clipPath id="clip0_33_172">
                                <rect width="128" height="128" fill="white" class="fill-background" />
                            </clipPath>
                        </defs>
                    </svg>
                    <span class="text-sm font-medium text-foreground mt-3">
                        No result found
                    </span>
