...
<footer class="mt-auto">
    <div class="mx-auto w-full lg:max-w-300 relative pt-20 border-dashed">
                ...
                <div class="flex flex-col mt-8">
                    ...
                    <div class="flex flex-wrap gap-2 mt-4">
                        <x-ui.link href="https://github.com/unoforge/flexiwind"
                            class="flex items-center px-2 h-6.5 rounded-ui ring ring-border-strong/70 text-sm text-muted-foreground hover:text-foreground hover:bg-card">
        ...
        <div class="col-span-full text-muted-foreground text-sm px-4 sm:px-6 lg:px-8 pb-3">
            <div class="text-sm border border-border bg-card/50 px-4 py-2 rounded-ui text-center">
                © unoForge {{ Date('Y') }}.
